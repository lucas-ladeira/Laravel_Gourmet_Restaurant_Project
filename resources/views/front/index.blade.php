...
<head>
  ...
  <!-- Main CSS File -->
  <link href="{{url('./assets/css/front/main.css')}}" rel="stylesheet">
          ...
          <div class="tab-pane fade active show" id="menu-starters">
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item">
                <a href="{{ route('routeSingleProduct.showSingleProduct', $p->id) }}"><img src="{{url('assets/images/'.$p->productImage)}}" class="menu-img img-fluid" alt="">
                  <h4>{{$p->productName}}</h4>
                  <p class="price">
                    $ {{$p->productPrice}}
                  </p>
              ...
              <div class="d-flex justify-content-center mt-4">
                {{ $products->appends(request()->query())->fragment('menu')->links() }}
              </div>
            </div>
          </div>
        </div>
