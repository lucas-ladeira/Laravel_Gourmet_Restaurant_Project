    ...
    <div class="content-wrapper">
      ...
      <div class="ibox">
        <div class="ibox-head">
          ...
          <a href="{{url('routeAjouterProduit')}}">
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><img src="{{url('assets/images/'.$p->photoP)}}" alt="" height="100px" width="50px"></td>
                  <td class="align-middle">{{$p->id}}</td>
                  <td class="align-middle">{{$p->nomP}}</td>
                  <td class="align-middle">{{$p->prixP}} $</td>
                  <td class="align-middle">{{$p->quantiteP}}</td>
                  <td class="align-middle">
                    ...
                    <a href="{{ route('routeModifierProduit.editProduit', $p->id) }}">
                      <button class="btn btn-default btn-xs m-r-5" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil font-14"></i></button>
                    </a>

                    <form action="{{ route('deleteProduit.destroy', $p->id) }}" method="post">
                      @csrf
                      @method('DELETE')
                      <button class="btn btn-default btn-xs" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-trash font-14"></i></button>
                    </form>
